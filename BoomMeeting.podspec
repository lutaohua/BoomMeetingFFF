Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/lutaohua/BoomMeeting"
  s.description = "BoomMeeting to create a meeting"
  s.frameworks = ["UIKit", "Foundation", "CoreFoundation", "UserNotifications", "CoreGraphics", "ReplayKit"]
  s.libraries = ["c", "sqlite3", "stdc++", "resolv", "sqlite3.0", "xml2", "z", "z.1.2.5"]
